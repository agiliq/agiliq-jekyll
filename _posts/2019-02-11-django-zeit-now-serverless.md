...
Now we have to rename _application to app_, as the builder will search for the `app` to run.
...
So first **create an RDS postgres instance** (which also comes in Free tier)
