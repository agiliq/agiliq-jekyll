...
date: 2019-04-22
categories: [API, django, django rest framework, drf]
author: Akshar
---
...
Stay tuned for next post where we would use advanced DRF features like ModelSerializer and generic views to reduce number of lines of code.
